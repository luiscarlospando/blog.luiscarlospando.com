        <footer class="container">
                ...
                <div class="col-12 col-md-10 offset-md-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-7 text-center text-lg-right">
                            ...
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <a href="https://<?php include "includes/site-domain.php"; ?>/suscribete/" class="badge badge-rss" data-toggle="tooltip" data-placement="top" title="Suscríbete">
            ...
            <div id="dismissable-alert">
                <p>
                    <em><time datetime="2025-08-01T16:48:08.000Z">Agosto, 2025</time></em> - 👋 Actualmente estoy disponible y abierto a nuevas oportunidades como desarrollador frontend.
