                ...
                <div class="col-12 col-md-10 offset-md-1">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            ...
                            <ul class="list-inline my-0">
                                <li class="list-inline-item">
                                    <a class="btn btn-primary btn-sm" href="https://webri.ng/webring/cssjoy/previous?via=https://luiscarlospando.com" data-toggle="tooltip" data-placement="top" title="Anterior">
                                        <i class="fa-solid fa-arrow-left"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn btn-primary btn-sm" href="https://webri.ng/webring/cssjoy/random?via=https://luiscarlospando.com" data-toggle="tooltip" data-placement="top" title="Sitio aleatorio">
                                        <i class="fa-solid fa-shuffle"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn btn-primary btn-sm" href="https://webri.ng/webring/cssjoy/next?via=https://luiscarlospando.com" data-toggle="tooltip" data-placement="top" title="Siguiente">
