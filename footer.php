                ...
                <div class="col-12 col-md-10 offset-md-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-7 text-center text-lg-right">
                            ...
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="103" height="20"><linearGradient id="s" x2="0" y2="100%"><stop offset="0" stop-color="#bbb" stop-opacity=".1"/><stop offset="1" stop-opacity=".1"/></linearGradient><clipPath id="r"><rect width="103" height="20" rx="3" fill="#fff"/></clipPath><g clip-path="url(#r)"><rect width="68" height="20" fill="#555"/><rect x="68" width="35" height="20" fill="#f783ac"/><rect width="103" height="20" fill="url(#s)"/></g><g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110"><image x="5" y="3" width="14" height="14" href="data:image/png;base64,"/><a target="_blank" href="https://home.omg.lol/referred-by/8bit"><rect width="68" x="19" height="20" fill="rgba(0,0,0,0)"/><text aria-hidden="true" x="435" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="410">omg.lol</text><text x="435" y="140" transform="scale(.1)" fill="#fff" textLength="410">omg.lol</text></a><a target="_blank" href="https://{{ site.omglol_username }}.{{ site.domain }}/"><rect width="35" x="68" height="20" fill="rgba(0,0,0,0)"/><text aria-hidden="true" x="845" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="250">mijo</text><text x="845" y="140" transform="scale(.1)" fill="#fff" textLength="250">mijo</text></a></g></svg>
                                </li>
                                <li class="list-inline-item">
                        ...
                        <div class="col-12 text-center">
                            <ul id="social" class="list-inline mt-0">
                                ...
                                <li class="list-inline-item">
                                    <a href="https://<?php include "includes/site-domain.php"; ?>/subscribe/" data-toggle="tooltip" data-placement="top" aria-label="RSS" title="RSS">
