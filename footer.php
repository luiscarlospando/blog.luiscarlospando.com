                        ...
                        <div class="col-12 col-lg-9 my-auto">
                            ...
                            <div class="row">
                                <div class="col-12 version text-lg-right my-auto">
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a href="" class="tinylytics_webring" data-toggle="tooltip" data-placement="top" title="🕸️💍 Tinylytics Webring (actualiza la página para un link aleatorio a un sitio dentro del webring)">
                                                🕸️💍 Tinylytics Webring <i class="fa-solid fa-arrow-right"></i> <img class="tinylytics_webring_avatar" src="" style="display: none"/>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
