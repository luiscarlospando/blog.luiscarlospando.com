                ...
                <div class="col-12 col-md-10 offset-md-1">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 text-center text-lg-left">
                           ...
                           <ul id="social" class="list-inline mt-0">
                            ...
                            <ul id="version" class="list-inline">
                                <li class="list-inline-item me-2">
                                    <a rel="me noreferrer noopener" href="https://proven.lol/75353b" data-toggle="tooltip" data-placement="top" aria-label="Proof" title="Proof" target="_blank">
                        ...
                        <div class="col-12 col-lg-6 my-auto text-center text-lg-right">
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <em><span id="greeting">Hola desde</span> <span id="weather-location" data-toggle="tooltip" data-placement="top" data-html="true" title="Cargando clima...">Chihuahua, México.</span></em>
                        ...
                        <div class="col-12 text-center">
                            ...
                            <ul class="list-inline my-0">
                                <li class="list-inline-item" style="margin-right: 1rem;">
                                    <nav aria-label="Blogblog Webring">
                                        <ul class="list-unstyled">
                                            <li class="mb-2">
                                ...
                                <li class="list-inline-item">
                                    <nav aria-label="CSS JOY Webring">
                                        <ul class="list-unstyled">
                                            <li class="mb-2">
