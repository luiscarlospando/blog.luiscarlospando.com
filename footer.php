                ...
                <div class="col-12 col-md-10 offset-md-1">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <ul class="list-inline my-0">
                                <li class="list-inline-item">
                                    <a href="" class="tinylytics_webring" data-toggle="tooltip" data-placement="top" title="Este link es aleatorio">
                                        🕸️💍 Tinylytics Webring <img class="tinylytics_webring_avatar" src="" style="display: none"/><br><i class="fa-solid fa-shuffle"></i>
                                    </a>
                                </li>
                            </ul>
                        </div>
