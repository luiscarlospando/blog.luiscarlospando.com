...
if ($toot_url) {
    echo '<a id="mastodon-toot" href="' .
        esc_url($toot_url) .
        '" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-mastodon"></i> Mastodon</a> (dale <i class="fa-solid fa-star"></i> <em>fav</em> o <i class="fa-solid fa-rocket"></i> <em>boost</em> para aparecer arriba)';
} else {
