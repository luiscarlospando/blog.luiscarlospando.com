             ...
             foreach ($tags as $tag) {
                 ...
                 echo '<a class="badge badge-custom" href="' .
					...
					<div class="comments-disclaimer mb-4">
						Por el momento estoy evaluando nuevos sistemas de comentarios para el blog. Pero si le das <em>like</em> o le das <em>boost</em> a este post en <?php include "includes/fetched-toot-link.php"; ?>, aparecerás aquí debajo. Si no tienes cuenta y te gustaría decirme algo, checa mi <a href="https://luiscarlospando.com/contacto"><i class="fa-solid fa-address-card"></i> página de contacto</a> o contáctame vía <a href="https://discordapp.com/users/86571896581132288/" rel="me" target="_blank"><i class="fa-brands fa-discord"></i> Discord</a>.
					</div>
