...
<head profile="http://gmpg.org/xfn/11" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#">
    ...
    <meta property="og:description" content="<?php if( is_single() ): ?><?php html5wp_excerpt('html5wp_index') ?><?php else: ?><?php bloginfo('description'); ?><?php endif; ?>" />
    ...
    <meta property="twitter:description" content="<?php if( is_single() ): ?><?php html5wp_excerpt('html5wp_index') ?><?php else: ?><?php bloginfo('description'); ?><?php endif; ?>" />
