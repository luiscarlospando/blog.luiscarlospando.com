...
<head profile="http://gmpg.org/xfn/11" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#">
	...
	<title><?php if( is_single() ): ?><?php the_title(); ?><?php echo ' - '; ?><?php endif; ?><?php bloginfo( 'name' ); ?></title>
    ...
    <meta name="description" content="<?php if( is_single() ): ?><?php the_excerpt_rss(); ?><?php else: ?><?php bloginfo('description'); ?><?php endif; ?>" />
    ...
    <meta property="og:title" content="<?php if( is_single() ): ?><?php the_title(); ?><?php echo ' - '; ?><?php endif; ?><?php bloginfo( 'name' ); ?>" />
    <meta property="og:description" content="<?php if( is_single() ): ?><?php the_excerpt_rss(); ?><?php else: ?><?php bloginfo('description'); ?><?php endif; ?>" />
    ...
    <meta property="twitter:title" content="<?php if( is_single() ): ?><?php the_title(); ?><?php echo ' - '; ?><?php endif; ?><?php bloginfo( 'name' ); ?>" />
    <meta property="twitter:description" content="<?php if( is_single() ): ?><?php the_excerpt_rss(); ?><?php else: ?><?php bloginfo('description'); ?><?php endif; ?>" />
